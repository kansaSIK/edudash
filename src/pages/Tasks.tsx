...
export default function Tasks({ 
  ...
  return (
    ...
    <div className="w-full bg-[#f8f9fa] dark:bg-[#1a1c1e] text-[#161d1f] dark:text-[#e2e2e5] font-body-main antialiased transition-colors duration-300 pb-10">
      ...
      <header className="flex justify-between items-center px-[20px] py-[16px] w-full bg-[#f8f9fa] dark:bg-[#1a1c1e] sticky top-0 z-40 border-b border-[#e9ecef]/50 dark:border-[#44474e]/50 shrink-0 transition-colors duration-300">
        ...
        <div className="flex gap-[12px] items-center shrink-0 relative">
          ...
          {isSortMenuOpen && (
            <>
              ...
              <div className="absolute right-0 top-[56px] w-[200px] bg-[#ffffff] dark:bg-[#2b2d30] border border-[#e9ecef] dark:border-[#44474e] rounded-xl shadow-lg z-50 flex flex-col py-2 transition-colors duration-300 animate-[fadeIn_0.2s_ease-out]">
      ...
      {/* FAB (Tombol Mengapung): fixed agar melayang dan tidak ikut di-scroll */}
      <button 
      ...
      {/* --- MODAL TAMBAH TUGAS ---: fixed inset-0 z-[999] agar layar terkunci dan menutupi header */}
      {isModalOpen && (
  ...
  <div className="w-1/2 flex flex-col gap-1">
    ...
    <input required type="date" className="w-full p-3 rounded-xl border border-[#c1c7d3] dark:border-[#44474e] bg-[#ffffff] dark:bg-[#1a1c1e] text-[#161d1f] dark:text-[#e2e2e5] focus:outline-[#005da7] text-sm transition-colors" value={taskDeadline} onChange={e => setTaskDeadline(e.target.value)} disabled={isSubmitting} />
  </div>
  <div className="w-1/2 flex flex-col gap-1">
    <label className="text-[10px] font-bold text-[#636e72] dark:text-[#c4c6d0] ml-1">Tingkat Prioritas</label>
    <select className="w-full p-3 rounded-xl border border-[#c1c7d3] dark:border-[#44474e] bg-[#ffffff] dark:bg-[#1a1c1e] text-[#161d1f] dark:text-[#e2e2e5] focus:outline-[#005da7] text-sm transition-colors" value={taskPriority} onChange={e => setTaskPriority(e.target.value as any)} disabled={isSubmitting}>
