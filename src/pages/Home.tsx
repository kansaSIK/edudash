...
const dict = {
  id: {
    ...
    priority_label: "Tingkat Prioritas",
...
export default function Home({ 
  ...
  return (
    // 1. PEMBUNGKUS UTAMA: w-full tanpa padding samping agar penuh
    <div className="w-full bg-[#f8f9fa] dark:bg-[#1a1c1e] text-[#161d1f] dark:text-[#e2e2e5] font-body-main antialiased transition-colors duration-300 pb-10">
      ...
      {/* 2. HEADER: sticky top-0 dan z-40 agar selalu menempel di atas */}
      ...
      {/* 3. KONTEN: Diberi padding mandiri agar isinya tidak menabrak layar */}
      ...
      {/* 4. MODAL: fixed, inset-0, z-[999] agar langsung menutupi seluruh layar dan tidak perlu scroll */}
      {isTaskModalOpen && (
            ...
            <form onSubmit={handleAddTask} className="flex flex-col gap-3">
              ...
              <div className="flex gap-3">
                <div className="w-1/2 flex flex-col gap-1">
                  <label className="text-[10px] font-bold text-[#636e72] dark:text-[#c4c6d0] ml-1">{t.deadline_label}</label>
                ...
                <div className="w-1/2 flex flex-col gap-1">
                  <label className="text-[10px] font-bold text-[#636e72] dark:text-[#c4c6d0] ml-1">{t.priority_label}</label>
      ...
      {/* MODAL KELAS JUGA MENGGUNAKAN FIXED Z-[999] */}
      {isClassModalOpen && (
        <div className="fixed inset-0 bg-[#161d1f]/60 z-[999] flex flex-col justify-end">
          <div className="bg-[#ffffff] dark:bg-[#2b2d30] w-full rounded-t-3xl p-6 flex flex-col gap-4 animate-[fadeInUp_0.3s_ease-out]">
            <div className="flex justify-between items-center mb-2">
