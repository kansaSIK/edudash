...
export default function Statistik({
  ...
  return (
    <div className={`bg-[#eef5f7] dark:bg-[#1a1c1e] min-h-screen flex items-center justify-center p-4 transition-colors duration-300`}>
      <div className="bg-[#ffffff] dark:bg-[#1a1c1e] text-[#161d1f] dark:text-[#e2e2e5] min-h-screen sm:min-h-[800px] h-full sm:h-[800px] w-full max-w-md sm:rounded-[2.5rem] sm:shadow-2xl flex flex-col font-body-main antialiased relative overflow-hidden pb-20 transition-colors duration-300">
        ...
        {/* --- HEADER --- */}
        <header className="flex justify-between items-center px-[20px] py-[16px] w-full bg-[#ffffff] dark:bg-[#1a1c1e] sticky top-0 z-10 transition-colors duration-300">
        ...
        {/* --- MAIN CONTENT --- */}
        <main className="flex-grow w-full overflow-y-auto no-scrollbar px-[20px] py-[16px] flex flex-col gap-[24px]">
